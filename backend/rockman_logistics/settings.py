"""
Django settings for rockman_logistics project.
...
SECRET_KEY = 'django-insecure-!(!rqj22u-lza=+*2)$tro-c=zb9nn*c(b0v7(h_d7$-za%@w3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'testserver', 'rockmanchina.onrender.com']
...
# Custom User Models - Using default Django User
...
ROOT_URLCONF = 'rockman_logistics.urls'
...
WSGI_APPLICATION = 'rockman_logistics.wsgi.application'
